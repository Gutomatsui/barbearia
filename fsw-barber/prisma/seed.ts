import { PrismaClient } from "@prisma/client"; // <-- Isso espera que o cliente esteja em node_modules/@prisma/client
    ...
    const services = [
      {
        ...
        duration: 60, // <<< ADICIONE ISSO AQUI (exemplo: 60 minutos)
      },
      {
        name: "Barba",
        ...
        duration: 45, // <<< ADICIONE ISSO AQUI (exemplo: 45 minutos)
      },
      {
        name: "Pézinho",
        ...
        duration: 15, // <<< ADICIONE ISSO AQUI
      },
      {
        name: "Sobrancelha",
        ...
        duration: 20, // <<< ADICIONE ISSO AQUI
      },
      {
        name: "Massagem",
        ...
        duration: 30, // <<< ADICIONE ISSO AQUI
      },
      {
        name: "Hidratação",
        ...
        imageUrl:
          "https://utfs.io/f/8a457cda-f768-411d-a737-cdb23ca6b9b5-b3pegf.png",
        duration: 25, // <<< ADICIONE ISSO AQUI
      },
    ];
      ...
      for (const service of services) {
        await prisma.barbershopService.create({
          data: {
            ...
            price: service.price,
            barbershopId: barbershop.id, // Adicionei isso, certifique-se que está lá
            imageUrl: service.imageUrl,
            duration: service.duration, // <<< ASSEGURE-SE QUE ESTÁ PASSANDO A DURATION AQUI
          },
        });
      }
